...
<div class=container>
<form method="post" action="./modifyReserveCtrl.php"> 
  ...
  <table class="table table-bordered" id="drop-table">
    <thead>
      <tr  id="rowid" name="rowid" class="row100 head">
        ...
        <th class="cell100 column5">Modify</th>
      </tr>
    </thead>
    ...
    //print_r($_POST);
      ...
      $sql = "Select reservation.Reserve_Id, reservation.Checkin_Date, reservation.Checkout_Date,reservation.Room_Id,room_details.RoomType from reservation join room_details on reservation.Room_Id=room_details.Room_Id";
     ...
     if($result->  num_rows > 0){
      	 while($row = $result-> fetch_assoc()) {
      		 ...
      		 <td>". $row["Room_Id"]."</td>
      		 <td>". $row["RoomType"]."</td>
      		 <td> ". "<input type=submit name=update value= Modify" ." </td>
      	 </tr>";
    	 }
	     echo "</table>";
      }
