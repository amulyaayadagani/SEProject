        ...
        if($_SESSION["available_count"] > 0){
                ...
                if ($conn->query($sqlReservation) === TRUE) {
                    $booking_id = $conn->insert_id;
                     ...
                     if ($conn->query($sqlRoomAvailability) === TRUE) {
                          ...
                          $sqlNotification = "INSERT INTO notification(C_ID, Message, date_received, subject, message_id) VALUES ($cid,'Dear Customer , Thank You for booking at our Hotel. Your Reservation Details are as follows: \n Booking Id = $booking_id \n Room Number = $Room_Num \n Checkin Date = $checkin_date \n Checkout Date = $checkout_date \n Reservation Date = $reservation_date \n Price = $Price','$reservation_date','Booking Confirmation',null)";
                            ...
                            echo '<meta http-equiv="refresh" content="1; URL=index.php?page=ModifyReservation" />';
                              ...
                              $test = "test";
                                $reserveError = "Error: Record not inserted "  . $conn->error;
                            }
          ...
          if ($conn->query($sqlCustomer) === TRUE) {
              ...
              if ($conn->query($sqlReservation) === TRUE) {
                  ...
                  $sqlNotification = "INSERT INTO notification(C_ID, Message, date_received, subject, message_id) VALUES ($cid,'Dear Customer, Thank You for booking at our Hotel. Your booking is currently waitlisted. Your booking details are as follows: \n Checkin Date = $checkin_date \n Checkout Date = $checkout_date \n Reservation Date = $reservation_date \n Price = $Price','$reservation_date','Booking Waitlisted',null)";
  ...
  <div class="site-block bg-white" id="background" data-aos="fade" data-aos-delay="100">
       ...
       <div class="row justify-content-center text-center mb-5">
         <div class="col-md-7">
          ...
          <?php if(!empty($_SESSION["Room_Num"])) : ?>
          <div class="row justify-content-center text-center">
            <div class="col-md-12">
              <span class="confirm-text">Room Number :</span>&nbsp;&nbsp;<span class="value-text"><?php if(!empty($_SESSION["Room_Num"])) { echo $_SESSION["Room_Num"]; } ?></span>
            </div>
          </div>
        <?php endif; ?>
           <div class="row justify-content-center text-center">
